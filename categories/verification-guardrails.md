...
- [jev-guard](https://github.com/leepokai/jev-guard) `{agent: multi}` - Agent security: prompt-injection and dangerous-action guard for Claude Code, Codex, Pi, and ACP agents, with Jev deciding what to block.
