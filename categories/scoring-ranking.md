...
- [jev-guard (leepokai)](https://github.com/leepokai/jev-guard) ![agent: Multi](https://img.shields.io/badge/agent-Multi-1F6FEB?style=flat-square) - Agent security: prompt-injection and dangerous-action guard for Claude Code, Codex, Pi, and ACP agents, with Jev deciding what to block.
